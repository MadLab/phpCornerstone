...
class Route
{
    ...
    /**
     * Checks if a given route is a custom router
     * @return bool
     */
    ...
    public function executeCustomRouter()
    {
        return call_user_func($this->routerCallback, $this->domain, $this->subdomain, $this->path, $this->pathVariables);
    }
