 ...
 * phpCornerstone
 *
 * A simple, well-designed PHP framework
 *
 * @package       phpCornerstone
 * @author        Nick Ashley
 * @copyright     Copyright (c) 2012, Horizontal Verticals, Inc.
 * @license       http://phpcornerstone.com/license/
 * @link          http://phpcornerstone.com
 * @since         Version 1.0
 *
 */

/**
 * phpCornerstone Email Class
 *
 * Permits email to be sent using Mail, Sendmail, or SMTP.
 *
 * This class has been graciously taken from the CodeIgniter framework. Code formatting was changed to fit
 * the phpCornerstone style guides. Special thanks to the ExpressionEngine Dev Team, and Open Source developers
 * everywhere. CodeIgniter Page headers follow.
 */
